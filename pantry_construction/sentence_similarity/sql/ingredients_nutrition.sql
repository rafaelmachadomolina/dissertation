-- Query to build table with nutritional information on ingredients and results
-- of matching algorithm.

-- DROP TABLE kp_ingredients_nutrition;
-- TRUNCATE TABLE kp_ingredients_nutrition;

CREATE TABLE kp_ingredients_nutrition AS
...
FROM
    (SELECT ingredient_id,
        ...
        ingredient_category_id,
        taxonomy_category_id
    FROM kp_ingredients_matched) T1
LEFT JOIN
    (SELECT id,
        nutrition_id,
